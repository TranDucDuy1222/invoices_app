...
class App(tk.Tk):
    ...
    def _create_pages(self):
        ...
        lich_su_frame = tk.Frame(self.main_content_frame, bg="lightyellow")
        lich_su_frame.grid(row=0, column=0, sticky="nsew")
        tk.Label(lich_su_frame, text="Đây là trang Lịch sử hóa đơn", font=("Segoe UI", 24)).pack(pady=100)
        self.frames["Lịch sử hóa đơn"] = lich_su_frame
